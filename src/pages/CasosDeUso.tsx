                ...
                <GlassCard>
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                    <div>
                      ...
                      <h4 className="text-sm font-semibold mb-1 text-accent">Solución</h4>
                      <p className="text-sm text-muted-foreground">{c.solucion}</p>
                    </div>
                    <div>
                      <h4 className="text-sm font-semibold mb-1 text-accent">Integraciones típicas</h4>
                      <p className="text-sm text-muted-foreground mb-4">{c.integraciones}</p>
                      <h4 className="text-sm font-semibold mb-1 text-accent">Resultado esperado</h4>
