          ...
          <motion.div {...fade}>
            <GlassCard highlight={i === 0} className="max-w-4xl mx-auto">
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mt-6">
                <div>
                  <h4 className="text-sm font-semibold text-primary mb-2">Qué incluye</h4>
                  <ul className="text-sm text-muted-foreground space-y-1.5">
                    {s.incluye.map((item, j) => <li key={j}>· {item}</li>)}
                  </ul>
                </div>
                <div>
                  <h4 className="text-sm font-semibold text-primary mb-2">Para quién</h4>
                  <p className="text-sm text-muted-foreground">{s.para}</p>
                </div>
                <div>
                  <h4 className="text-sm font-semibold text-primary mb-2">Tiempo orientativo</h4>
